/*22.Write a program which copies contents of source singly linear linked list
whose addition of digits is prime number to destination singly linear linked list.*/
...
public void digitsumprime(LinkedList src)
{
